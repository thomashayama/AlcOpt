...
with st.form("Tasting Form"):
    ...
    boldness = st.slider(
        ...
        max_value=5.0,
        step=0.1,
        help="""A bold wine is typically full-bodied, high in tannins, and has strong flavors that linger. It often has higher alcohol content and a more pronounced texture, making it feel heavier in the mouth. Examples include Cabernet Sauvignon, Malbec, and Syrah.
    ...
    acidity = st.slider(
        ...
        max_value=5.0,
        step=0.1,
        help="""A soft wine has lower acidity, creating a round, mellow, and smooth mouthfeel. It lacks sharpness or tartness and tends to feel plush and easy-drinking. Soft wines often emphasize ripe fruit flavors and have a gentle finish. Examples include Merlot, Viognier, and oaked Chardonnay.
